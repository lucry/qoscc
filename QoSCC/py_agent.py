...
class PY_Agent:
    def __init__(self, shmem, shmem_rl):
        ...
        self.cummu_reward = 0 #cummulated reward
    ...
    def get_state(self):
        ...
        if len(s0) == self.params.dict['input_dim']:
            ...
            print("get state:", ack, s0)
            self.cummu_reward = (1-self.params.dict["commu_infactor"])*reward+self.params.dict["commu_infactor"]*self.cummu_reward
            # if (sending_period > 0):
            ...
            if sending_period >= 0:
                ...
                is_terminal = True
            self.drl_model.store_experience(self.s0, self.a, reward, state, is_terminal)
            # print(self.s0 == state)
            ...
            return state, reward, ack, is_terminal
        else:
        ...
        if self.drl_model.rp_buffer.ptr > 200 or self.drl_model.rp_buffer.full:
            ...
            if self.params.dict['use_hard_target'] == False:
                ...
                if self.counter % self.params.dict['hard_target'] == 0:
                    ...
                    logger.info("Cummulated reward is:{}".format(self.cummu_reward))
